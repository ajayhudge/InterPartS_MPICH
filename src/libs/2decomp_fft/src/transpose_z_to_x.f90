...
!  if (nrank.eq.1) then
!     print*,"sendcounts:",decomp%zcnts_xz,"sdispls:",decomp%zdispls_xz,"sendtypes",decomp%ztypes_xz,&
!          "recvcounts",decomp%xcnts_xz,"rdispls",decomp%xdispls_xz,"recvtypes",decomp%xtypes_xz
!  end if
